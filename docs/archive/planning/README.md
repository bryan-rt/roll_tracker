> **FROZEN — January 2026 worker-thread specifications.** Superseded as SPECIFICATION by
> CLAUDE.md and `.claude/rules/*`. Retained as a DESIGN-INTENT RECORD: these documents
> capture WHY the architecture was built as it is (e.g. A1/A2 establish the "short,
> high-precision tracklets, intentionally allowed to break" intent). Do not treat as
> current spec.
>

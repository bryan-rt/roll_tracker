# E2 — Gym Multi-Mat / Spatial Partitioning (optional)
...
## Module-specific context (E2 — multi-mat partitioning)
If multiple mats exist in frame, we need to avoid cross-mat pairing.

### Must include
- Approach: ROI polygons per mat or clustering in ground-plane
- Assignment rules + hysteresis for mat membership
- Failure cases (near boundary, camera shift)

...
- **Next:** CP17 follow-up — cross-camera merge tie-breaking for equal-confidence assignments. Coordinate channel (Tier 2/3) stubbed for CP18.
...
- **Last updated:** 2026-03-26 (CP17 Tier 1 — two-pass cross-camera ILP with tag corroboration + must_link bug fix)

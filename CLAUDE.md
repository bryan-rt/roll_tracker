...
- **Last updated:** 2026-03-17 (processor: multiplex_AC mode, wall-clock filter, resilient empty-video handling; Stage A frame_bgr→image_bgr fix; camera_id passthrough to Stage A)

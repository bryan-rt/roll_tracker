...
#   -i "$URL" \
#   -map 0:v:0 -map 0:a:0 -c:v copy -c:a aac -ar 48000 -ac 1 -b:a 64k \
#   -f segment -segment_time "${SEG_SECONDS:-120}" -strftime 1 \
#   -movflags +faststart+frag_keyframe+empty_moov \
#   "$DIAG_DIR/cam1-%Y%m%d-%H%M%S.mp4" \

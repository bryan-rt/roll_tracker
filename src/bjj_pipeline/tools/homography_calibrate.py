    ...
    def on_key(event):
        ...
        if k == "u":
            ...
            if K_existing is not None:
                ...
                # === MODE A: No K+dist — save 4-point H only ===
                print("[CP19] Mode A: No lens calibration found. Saving 4-point H.")
                print("[CP19] Run lens_calibration.py next, then re-run this tool for refinement.")

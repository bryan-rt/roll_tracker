...
## Module-specific context (Z1 — observability)
Debuggability is non-negotiable.

### Must include
- Standard debug artifacts per stage:
  - overlays (bbox/mask/IDs)
  - graphs (MCF chosen edges)
  - match timeline plots
- Naming + sampling strategy (don’t explode disk)
- Audit event schema proposal (ties back to F0)

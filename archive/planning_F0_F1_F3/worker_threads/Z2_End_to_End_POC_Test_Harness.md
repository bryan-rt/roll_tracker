# Z2 — End-to-End POC Test Harness
...
## Module-specific context (Z2 — end-to-end test harness)
We need a reliable way to verify pipeline correctness.

### Must include
- Synthetic fixtures for each stage (no GPU required)
- Minimal real clip harness (optional)
- Integration test that runs: A -> (optional B/C) -> D -> E with synthetic inputs
- CI notes and runtime constraints
